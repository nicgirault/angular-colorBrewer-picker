...
uis.controller('uiSelectCtrl',
  ...
  ctrl.searchInput = $element.querySelectorAll('input.ui-select-range');
  if (ctrl.searchInput.length !== 1) {
    throw uiSelectMinErr('searchInput', "Expected 1 input.ui-select-range but got '{0}'.", ctrl.searchInput.length);
  }
