...
angular.module('colorBrewer').directive('palettePicker', function(colorBrewer) {
  return {
    restrict: 'E',
    scope: {},
...
angular.module('colorBrewer').directive('palette', function(colorBrewer) {
  return {
    restrict: 'E',
    scope: {
      palette: '=colors',
...
},{"./directives/palette-picker.js":1,"./directives/palette.js":2,"./services/palettes.js":4}],4:[function(require,module,exports){
(function(angular) {
