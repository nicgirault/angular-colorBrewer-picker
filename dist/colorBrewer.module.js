...
(function(angular) {
  ...
  angular.module('colorBrewer').directive('colorBrewerPicker', function(colorBrewer) {
    return {
      restrict: 'E',
      scope: {
      ...
      link: function(scope, element) {
        ...
        return scope.palettes = palettes;
      }
    };
  });
  return angular.module('colorBrewer').directive('colorBrewerPickerSelect', function() {
    return {
      restrict: 'E',
      scope: {
